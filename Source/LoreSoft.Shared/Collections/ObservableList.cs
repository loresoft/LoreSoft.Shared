...
namespace LoreSoft.Shared.Collections
{
    ...
    public class ObservableList<T> : IList<T>, IList, INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Gets a <see cref="T:System.Collections.Generic.List`1" /> wrapper around the <see cref="T:LoreSoft.Shared.Collections.ObservableList`1" />.
        /// </summary>
        /// <returns>
        /// A <see cref="T:System.Collections.Generic.List`1" /> wrapper around the <see cref="T:LoreSoft.Shared.Collections.ObservableList`1" />.
        /// </returns>
        ...
        public void AddRange(IEnumerable<T> collection)
        {
            ...
            OnCountChanged();
            OnItemsChanged();
            OnCollectionAdd(oldCount, collection.ToArray());
        }
